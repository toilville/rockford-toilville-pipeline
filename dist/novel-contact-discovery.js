...
class NovelContactDiscovery {
     ...
     */
    async fetchAllNotionContactsDetailed() {
    ...
    async addNotionContactsToArray(databaseId, contactArray) {
     ...
     */
    isContactNovel(appleContact, notionContacts) {
        ...
        return !notionContacts.some(notionContact => {
            ...
            if (appleName === notionName)
                return true;
            // Check for email match
            if (appleEmail && notionEmail && appleEmail === notionEmail)
                return true;
            ...
            if (appleContact.firstName && appleContact.lastName && notionContact.firstName && notionContact.lastName) {
                ...
                if (appleFullName === notionFullName)
                    return true;
            }
            return false;
        });
     ...
     */
    findNovelContacts(appleContacts, existingNotionContacts) {
